...
while($row_brands=mysqli_fetch_array($run_brands)){
	...
	echo "<li><a href='index2.php?brand=$brand_id'>$brand_title</a></li>";
...
function getPro(){
	...
	while($row_pro=mysqli_fetch_array($run_pro)){
       ...
       <p><b> Tk. $pro_price	</b></p>
		...
		<a href='index.php?add_cart=$pro_id'><button style='float:right'>Book Place</button></a>
...
function getCatPro(){
	...
	$get_cat_pro = "SELECT * FROM `products` WHERE `product_cat` = '$cat_id' ORDER BY `product_price`";
...
function getBrandPro(){
	...
	$get_brand_pro = "SELECT * FROM `products` WHERE `product_brand` ='$brand_id' ORDER BY `product_price`";
