	...
	<body>
	 ...
	 <div class="main_wrapper">
			...
			<div class="content_wrapper">
                ...
                echo "<p style='text-align:center;'><img src ='customer/customer_images/$c_image'width='150' height='150'/>";
				  ...
				  ?>
					...
					<li><a href="customer/my_account.php?view_orders">View Orders</a></li>
					<li><a href="customer/my_account.php?delete_account">Delete Account</a></li>
				...
				<b>you can see your orders progress by clicking this <a href='customer/my_account.php?view_orders'>link</a></b>";
						}
					   ...
					   ?>
						...
						<?php
						  ...
						  if (isset($_GET['view_orders'])){
                             include("customer/view_orders.php");
						  }
